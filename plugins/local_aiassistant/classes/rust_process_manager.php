<?php
// DUMMY VERSION FOR UI DEBUGGING
...
class rust_process_manager {
    ...
    public function process_request(
        int $userid, string $message, array $context, array $history, ?string $large_input
    ) {
        sleep(1);
        $responseText = "✅ UI DEBUG MODE: Response to '{$message}'. The UI is working!";
        return ['success' => true, 'ai_response_text' => $responseText];
    }
}
